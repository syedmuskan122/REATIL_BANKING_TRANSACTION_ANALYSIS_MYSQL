...
-- --------------------------------------------------------------------------------------------------------------------------------------
-- *** IMPORTANT POINTS ***
-- First, We need to put open_date & close_date in 'VARCHAR(50)' DataTypes.
-- Second, then need to create table.
-- Third, Import .csv files.
-- Fourth, Check the count of all .csv files are correct or not.
-- Fifth, Chnage the open_date & close_date in 'VARCHAR(50)' DataTypes to 'DATE'. & Then Run 'SET' Function Lines code.
-- Sixth, Then Verify DataBase ER Diagram of Account table column 'open_date' & 'close_date' is in 'DATE' DataType only or not need to check.
-- --------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE accounts
SET open_date = DATE_FORMAT(
    STR_TO_DATE(open_date, '%d-%m-%Y'),
    '%Y-%m-%d'
)
